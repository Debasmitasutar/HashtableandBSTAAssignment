...
public class MyHashMap<K,V>{
    ...
    // This method to get value from LinkedList using index number key : key is returned
    public V get(K key) {
    ...
    //Method to search the word in LinkedList  key : key to search
    ...
    //Method to append value to Linked List  myNode : value to append
